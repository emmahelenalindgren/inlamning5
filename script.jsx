...
function plus(event){
    ReactDOM.render(
    <Sum summa = {firstNumber + secondNumber} />,
...
class Btn extends React.Component {
  ...
  render() {
    return (
      ...
      <div>
        <button onClick={this.btn1Value}>Första knappen</button>
        <button onClick={this.btn2Value}>Andra knappen</button><br />
        <span className="textsize">Vilken knapp tryckte du på? <br /> {this.state.value}</span>
